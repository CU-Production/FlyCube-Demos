...
int main(int argc, char *argv[])
{
    ...
    AppBox app("05 - RayTracing", settings);
    ...
    RaytracingGeometryDesc raytracing_geometry_desc = { { positions, gli::format::FORMAT_RGB32_SFLOAT_PACK32, 6 }, {}, RaytracingGeometryFlags::kOpaque };
